...
class Audio(Enum):
    ...
    QUAL_DESEJA = _caminho_falas + 'qual deles você deseja.mp3'
    ...
    NAO_ENTENDI = _caminho_falas + 'não entendi.mp3'
    NAO_VEJO_MAO = _caminho_falas + 'não vejo mais sua mão.mp3'
